    ...
    <div style={{ marginBottom: 32 }}>
      <button
        ...
        style={{
          ...
          background: th.surface, border: `1px solid ${open ? "#00d4aa55" : th.border}`,
          borderRadius: 12, padding: "10px 16px", cursor: "pointer",
          transition: "all 0.2s", width: "100%", maxWidth: 420,
        }}
      >
        <span style={{ fontSize: 14 }}>📊</span>
        <span style={{ fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: 11, letterSpacing: 1, color: open ? "#00d4aa" : th.text, flex: 1, textAlign: "left" }}>
          2026 Algorithm Breakdown (11 Factors)
        </span>
      ...
      {open && (
        <div style={{
          marginTop: 10, background: th.surface, border: `1px solid ${th.border}`,
          borderRadius: 14, padding: "18px 20px", animation: "fadeUp 0.3s ease",
          maxWidth: 620,
        }}>
          <div style={{
            ...
            {FACTORS.map(f => (
              <div key={f.key} style={{
                ...
                <span style={{ fontSize: 9, color: f.color, flexShrink: 0 }}>●</span>
                <span style={{
                  fontFamily: "'Syne',sans-serif", fontWeight: 700, fontSize: 11,
                  color: th.text, flex: 1, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis",
                }}>
                  {f.label}
                </span>
                {f.isNew && (
                  <span style={{
                    fontSize: 8, fontWeight: 800, background: "#00d4aa1f", color: "#00d4aa",
                    padding: "2px 5px", borderRadius: 4, flexShrink: 0, letterSpacing: 0.5,
                  }}>NEW</span>
                )}
                <span style={{
                  fontFamily: "'Syne',sans-serif", fontSize: 12, fontWeight: 800, color: f.color, flexShrink: 0, minWidth: 28, textAlign: "right",
                }}>{f.w}%</span>
              </div>
            ))}
          </div>
          <div style={{ fontSize: 10, color: th.muted, marginTop: 12, textAlign: "center" }}>
            Weights based on Fiverr's official 2026 ranking algorithm
          </div>
        </div>
      )}
    </div>
      ...
      <div style={{position:"relative",zIndex:1,maxWidth:900,margin:"0 auto",padding:"0 20px 80px"}}>
        ...
        {!mod&&(
          <div className="home-hero" style={{paddingTop:44,paddingBottom:36,animation:"fadeUp 0.5s ease"}}>
            ...
            <h1 className="home-h1" style={{fontFamily:"'Syne',sans-serif",fontSize:"clamp(32px,7vw,56px)",fontWeight:900,lineHeight:1.05,letterSpacing:-2,marginBottom:14,color:th.text,wordBreak:"break-word"}}>
