    ...
    <div style={{ marginBottom: 32 }}>
      ...
      >
        ...
        <span style={{
          ...
          letterSpacing: 0.5, color: open ? "#00d4aa" : th.text,
        ...
        <span style={{
          ...
          color: th.muted, background: th.bg, padding: "2px 8px",
          borderRadius: 20, border: `1px solid ${th.border}`, flexShrink: 0,
        }}>11 Factors</span>
        <span style={{
          fontSize: 12, color: open ? "#00d4aa" : th.muted,
  ...
  return(
    <div style={{minHeight:"100vh",background:th.bg,transition:"background 0.3s",fontFamily:"'DM Sans',system-ui,sans-serif",color:th.text}}>
      <style>{`*{box-sizing:border-box;margin:0;padding:0} input::placeholder,textarea::placeholder{color:${th.border}} @keyframes spin{to{transform:rotate(360deg)}} @keyframes fadeUp{from{opacity:0;transform:translateY(16px)}to{opacity:1;transform:translateY(0)}}
        ...
        @media(max-width:480px){.algo-grid{grid-template-columns:1fr!important}}
      `}</style>
        ...
        {!mod&&(
          <div className="home-hero" style={{paddingTop:44,paddingBottom:36,animation:"fadeUp 0.5s ease"}}>
            <div style={{display:"inline-flex",alignItems:"center",gap:8,marginBottom:18,flexWrap:"wrap"}}>
              <div style={{width:8,height:8,borderRadius:"50%",background:"#00d4aa",boxShadow:"0 0 12px #00d4aa",animation:"spin 3s linear infinite",flexShrink:0}}/>
